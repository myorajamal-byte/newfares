        ...
        <div className="space-y-4">
          {isGenerating ? (
            <div className="text-center py-8">
              ...
              <p className="text-lg font-semibold">جاري تحضير الفاتورة للطباعة...</p>
              <p className="text-sm text-gray-600 mt-2">يتم تحميل بيانات العميل وتحضير الفاتورة</p>
            </div>
          ) : (
            <>
              {/* Currency display */}
              ...
              <div className="text-sm text-green-600 bg-green-50 p-3 rounded">
                💡 ستطبع الفاتورة بتصميم احترافي يشبه الفاتورة المرفقة مع تفاصيل اللوحات والأسعار
              </div>
